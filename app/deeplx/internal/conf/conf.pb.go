...
type Data_Cache struct {
	...
	ClientCache bool                 `protobuf:"varint,1,opt,name=client_cache,json=clientCache,proto3" json:"client_cache,omitempty"`
...
func (x *Data_Cache) GetClientCache() bool {
	if x != nil {
		return x.ClientCache
	}
	return false
}
...
var file_internal_conf_conf_proto_rawDesc = []byte{
	...
	0x28, 0x05, 0x52, 0x02, 0x64, 0x62, 0x1a, 0x57, 0x0a, 0x05, 0x43, 0x61, 0x63, 0x68, 0x65, 0x12,
	0x21, 0x0a, 0x0c, 0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x5f, 0x63, 0x61, 0x63, 0x68, 0x65, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0b, 0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x43, 0x61, 0x63,
	0x68, 0x65, 0x12, 0x2b, 0x0a, 0x03, 0x74, 0x74, 0x6c, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32,
