...
func (uc *UserCreate) SetToken(u uuid.UUID) *UserCreate {
	uc.mutation.SetToken(u)
	return uc
}
...
func (uc *UserCreate) AddAccessLogIDs(ids ...int64) *UserCreate {
	uc.mutation.AddAccessLogIDs(ids...)
	return uc
}

// AddAccessLogs adds the "access_logs" edges to the AccessLog entity.
func (uc *UserCreate) AddAccessLogs(a ...*AccessLog) *UserCreate {
	ids := make([]int64, len(a))
	for i := range a {
		ids[i] = a[i].ID
	}
	return uc.AddAccessLogIDs(ids...)
}
...
func (uc *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if nodes := uc.mutation.AccessLogsIDs(); len(nodes) > 0 {
...
// SetToken sets the "token" field.
func (u *UserUpsert) SetToken(v uuid.UUID) *UserUpsert {
...
// SetToken sets the "token" field.
func (u *UserUpsertOne) SetToken(v uuid.UUID) *UserUpsertOne {
	return u.Update(func(s *UserUpsert) {
		s.SetToken(v)
	})
}
...
// SetToken sets the "token" field.
func (u *UserUpsertBulk) SetToken(v uuid.UUID) *UserUpsertBulk {
	return u.Update(func(s *UserUpsert) {
		s.SetToken(v)
	})
}
